...
export default function ScrollRing() {
  ...
  return (
    <motion.div
      className="fixed bottom-28 right-6 md:bottom-8 md:right-8 w-16 h-16 md:w-20 md:h-20 rounded-full bg-gray-900/80 backdrop-blur-sm border-2 border-cyan-500/30 flex items-center justify-center z-40 md:z-50 overflow-visible"
